...
public class CarDatabase {
    ...
    public void addCars(int count) {
        ...
        for (int i=0;i<count; i++){
            ...
            System.out.println("Jaký má auto rok výroby? (excellent, good, bad, damaged");
    ...
    public void printCarWithMostDrivenKm(){
        ...
        System.out.println("Auto s nejvíce najetými km je: "+cars[nejvice]+" a najelo "+nejviceNajete+" km");
    }
    public void printInterestingThings(){
        ...
        System.out.println("Počet znaků tohoto jména je: "+owner);
